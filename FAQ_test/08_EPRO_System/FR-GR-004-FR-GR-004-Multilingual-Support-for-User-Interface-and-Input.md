---
title: "FR-GR-004: FR-GR-004: Multilingual Support for User Interface and Input Contents"
tags: [epro, EPRO_System]
---

# FR-GR-004: FR-GR-004: Multilingual Support for User Interface and Input Contents

## 需求描述

Requirement ID:	FR-GR-004	Requirement Type:	General Requirements
Parent Requirement #:
None
Description:
...
The Platform shall allow users to easily switch between the supported languages for the user interface.
