---
title: "FR-GR-013: FR-GR-013: Notification and Alert Feature"
tags: [epro, EPRO_System]
---

# FR-GR-013: FR-GR-013: Notification and Alert Feature

## 需求描述

Requirement ID:	FR-GR-013	Requirement Type:	General Requirements
Parent Requirement #:
None
Description:
...
The status of the general Request e-Form that does not require approval is as follows:
Draft
Cancelled
Finished
The status of the Request e-Form that requires approval is as follows:
Draft
Cancelled
Pending Approval
Approved
Rejected/Withdrew
Returned (Resubmission allowed)
The status of the RFQ / Tender exercise is as follow:
Pre-Tender stage
Draft
Cancelled
Tender stage
...
Awarded/Finished
Terminated
External Suppliers should receive standard notification emails in the following scenario:
