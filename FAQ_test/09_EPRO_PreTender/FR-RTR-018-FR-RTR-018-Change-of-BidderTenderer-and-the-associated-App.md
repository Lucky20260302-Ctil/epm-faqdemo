---
title: "FR-RTR-018: FR-RTR-018: Change of Bidder/Tenderer and the associated Approval Process"
tags: [epro, EPRO_PreTender]
---

# FR-RTR-018: FR-RTR-018: Change of Bidder/Tenderer and the associated Approval Process

## 需求描述

Requirement ID:	FR-RTR-018	Requirement Type:	RFQ and Tender	Requirements
Parent Requirement #:
FR-RTR-003 – Preparation of RFQ / Tender Invitations
Description:
This requirement addresses the need for modifying the Bidder/Tenderer and the associated Approval Process.
Rationale:
None
...
The option for the RFQ / Tender exercise may require e-Form for management and control, which can be used before the invitation closing date and time of the RFQ / Tender:
