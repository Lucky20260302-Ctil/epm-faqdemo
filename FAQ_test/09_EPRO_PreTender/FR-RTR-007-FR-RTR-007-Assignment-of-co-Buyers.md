...
Requirement ID:	FR-RTR-007	Requirement Type:	RFQ and Tender	Requirements
Parent Requirement #:
FR-RTR-003 - Preparation of RFQ / Tender Invitations
Description:
This requirement addresses the need to assign or modify co-buyers who are responsible for managing the RFQ/Tender process.
Rationale:
None
