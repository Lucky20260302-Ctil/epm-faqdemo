---
title: "FR-RTR-031: FR-RTR-031: Issuance of RFQ / Tender Invitations"
tags: [epro, EPRO_PreTender]
---

# FR-RTR-031: FR-RTR-031: Issuance of RFQ / Tender Invitations

## 需求描述

Requirement ID:	FR-RTR-031	Requirement Type:	RFQ and Tender	Requirements
Parent Requirement #:
None
Description:
...
The breakdown of the use cases for Procurement Strategy Request is outlined as follows:
The breakdown of the use cases for the report feature is outlined as follows:
...
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Assignment of co-Buyers Request is outlined as follows:
The breakdown of the use cases for Declaration of Conflicts of Interest is outlined as follows:
The breakdown of the use cases for Compliance Verification for DOI is outlined as follows:
The breakdown of the use cases for DOI Approval Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Assignment of View-only Users Request is outlined as follows:
The breakdown of the use cases for Declaration of Conflicts of Interest is outlined as follows:
The breakdown of the use cases for Compliance Verification for DOI is outlined as follows:
The breakdown of the use cases for DOI Approval Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Assignment of Price Assessment Panel Members Request is outlined as follows:
The breakdown of the use cases for Declaration of Conflicts of Interest is outlined as follows:
The breakdown of the use cases for Compliance Verification for DOI is outlined as follows:
The breakdown of the use cases for DOI Approval Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Assignment of Technical Assessment Panel Members Request is outlined as follows:
The breakdown of the use cases for Declaration of Conflicts of Interest is outlined as follows:
The breakdown of the use cases for Compliance Verification for DOI is outlined as follows:
The breakdown of the use cases for DOI Approval Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Assignment of RFQ / Tender Opening Team Members Request is outlined as follows:
The breakdown of the use cases for Declaration of Conflicts of Interest is outlined as follows:
The breakdown of the use cases for Compliance Verification for DOI is outlined as follows:
The breakdown of the use cases for DOI Approval Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Pricing Schedule with Requisition Item Group(s) Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Declaration of Conflicts of Interest is outlined as follows:
The breakdown of the use cases for Compliance Verification for DOI is outlined as follows:
...
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Discard RFQ / Tender Exercise Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Set up RFQ / Tender Notice Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Change of Bidder/Tenderer Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Set up Contact Point for RFQ / Tender Invitations Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Upload of RFQ / Tender Documents and Annex(s) Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Need for Queries Configuration Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Need for Addendums Configuration Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Extension Closing Date and Time Configuration Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for E-Tender Box Configuration Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Set up Rounds of Technical Evaluation Configuration Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Postpone Closing Date and Time Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.
The breakdown of the use cases is outlined as follows:
The breakdown of the use cases for Issuance of RFQ / Tender Invitations Request is outlined as follows:
The details of the use cases will be documented and reviewed in the later SA&D stage.