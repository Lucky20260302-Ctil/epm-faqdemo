...
category_label: ''
quality: stub
title: 'FR-RTR-009: FR-RTR-009: Assignment of Price Assessment Panel Members'
---
# FR-RTR-009: FR-RTR-009: Assignment of Price Assessment Panel Members

## 需求描述

Requirement ID:	FR-RTR-009	Requirement Type:	RFQ and Tender	Requirements
Parent Requirement #:
FR-RTR-003 – Preparation of RFQ / Tender Invitations
Description:
This requirement addresses the need to assign or modify of members who will participate in the commercial evaluation for the RFQ/Tender.
Rationale:
None
...
The option for the RFQ / Tender exercise may require e-Form for management and control, which can be used before the completion of the RFQ/Tender evaluation and negotiation:
