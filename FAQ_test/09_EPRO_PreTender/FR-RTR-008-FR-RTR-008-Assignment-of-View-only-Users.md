---
title: "FR-RTR-008: FR-RTR-008: Assignment of View-only Users"
tags: [epro, EPRO_PreTender]
---

# FR-RTR-008: FR-RTR-008: Assignment of View-only Users

## 需求描述

Requirement ID:	FR-RTR-008	Requirement Type:	RFQ and Tender	Requirements
Parent Requirement #:
FR-RTR-003 – Preparation of RFQ / Tender Invitations
Description:
This requirement addresses the need to assign or modify view-only users who need access to review the details on the Platform for this RFQ/Tender.
Rationale:
None
...
The option for the RFQ / Tender exercise may require e-Form for management and control, which can be used before awarded / finished / terminated RFQ / Tender:
