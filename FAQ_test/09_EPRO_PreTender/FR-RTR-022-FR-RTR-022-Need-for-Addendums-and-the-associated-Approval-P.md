...
category_label: ''
quality: stub
title: 'FR-RTR-022: FR-RTR-022: Need for Addendums and the associated Approval Process Configuration'
---
# FR-RTR-022: FR-RTR-022: Need for Addendums and the associated Approval Process Configuration

## 需求描述

Requirement ID:	FR-RTR-022	Requirement Type:	RFQ and Tender	Requirements
Parent Requirement #:
FR-RTR-003 – Preparation of RFQ / Tender Invitations
Description:
This requirement addresses the need for managing Addendums and the associated Approval Process.
Rationale:
None
