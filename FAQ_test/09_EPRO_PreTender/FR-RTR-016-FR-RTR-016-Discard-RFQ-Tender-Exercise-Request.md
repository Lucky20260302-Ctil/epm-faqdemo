...
Requirement ID:	FR-RTR-016	Requirement Type:	RFQ and Tender	Requirements
Parent Requirement #:
FR-RTR-003 - Preparation of RFQ / Tender Invitations
Description:
This requirement addresses the need to manage the process of discarding an RFQ/Tender exercise.
Rationale:
None
