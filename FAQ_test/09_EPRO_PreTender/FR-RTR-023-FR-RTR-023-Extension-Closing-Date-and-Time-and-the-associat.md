---
title: "FR-RTR-023: FR-RTR-023: Extension Closing Date and Time and the associated Approval Process Configuration"
tags: [epro, EPRO_PreTender]
---

# FR-RTR-023: FR-RTR-023: Extension Closing Date and Time and the associated Approval Process Configuration

## 需求描述

Requirement ID:	FR-RTR-023	Requirement Type:	RFQ and Tender	Requirements
Parent Requirement #:
FR-RTR-003 - Preparation of RFQ / Tender Invitations
Description:
This requirement addresses the need for managing requests for extension to the Closing Date and Time, along with the associated Approval Process.
Rationale:
None
