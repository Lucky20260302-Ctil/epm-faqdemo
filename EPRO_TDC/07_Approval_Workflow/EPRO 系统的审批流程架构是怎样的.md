---
project: EPRO_TDC
title: EPRO 系统的审批流程架构是怎样的？
category: 审批流程
source: Approver Manual Section 4 Page 9-17
tags:
  - epro
  - approver
  - faq
...
to ensure system security and resource efficiency: User Type Session Timeout Internal Users 1 hour
...
### 4.2.2.2 My Task – Other Pending Actions
...
### 4.2.2.3 My Task – Pending Approvals
...
### 4.2.2.4 My Task – Completed Task
...
For resubmitted approval record:
