---
project: EPRO_TDC
title: 审批人如何使用澄清工具（Clarification Tool）与发起人沟通？
category: 审批流程
source: Approver Manual Section 5.3.1 Page 22-31
tags:
  - epro
  - approver
  - faq
...
5.3 Review Approval Request

    5.3.1   Clarification tool


Approver can raise a new clarification during the approval process, to address minor issues or
...
Step 2: Fill in the clarification details as follows:
 ...
 Title             Mandatory             Creates a discussion thread and separates different
                                                  issues.
 ...
 Attachment        Optional             Allows additional supporting documents to be uploaded.
...
clarification receives an email notification. Other approvers remain notified via system
notifications only.
...
6  Amend e-Form - Approver can revise minor mistakes, e.g. typos, during the approval
       process using the “Amend e-Form" function. Edits are limited primarily to text fields,
      and the approval route remains unchanged and non-editable
