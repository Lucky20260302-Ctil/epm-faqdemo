...
category_label: ''
quality: stub
title: 'FR-RTR-021: FR-RTR-021: Need for Queries and the associated Approval Process Configuration'
---
# FR-RTR-021: FR-RTR-021: Need for Queries and the associated Approval Process Configuration

## 需求描述

Requirement ID:	FR-RTR-021	Requirement Type:	RFQ and Tender	Requirements
Parent Requirement #:
FR-RTR-003 – Preparation of RFQ / Tender Invitations
Description:
This requirement addresses the need for managing Queries and the associated Approval Process.
Rationale:
None
