...
### Jira Comments (5 則)
**Sang** (2025-09-09):
@@Daniel Leung POS has passed region code to WpfWebview for display ‘Axciom Member Purchase History’ before  v750.04R14a; and on/after v750.04R14a, region code + tblconfig.crm_api_config was passed to WpfWebview for display ‘Axciom/Memberson Member Purchase History’.
v750.04R14a
1. 
Source code uploaded to
1.  R14a - svn://sanyosvn.ctil.com/svn/SvnPepository/tags/PosNetFE/7.5.0.04/7.5.0.04R14A
1.
**Daniel Leung** (2025-09-09):
@@Sherman tse 
 API - \\ds411\share\POS_MPOS_Release\3.30.x\3.30.6-20250908.1
IPA - 3.30.6-20250908.1 PreCoach
 @@Joy Li
！！！！！！！！ Please note that  “crm_api_config“ should use dbconfig_value instead of dbconfig_long_value. Sorry for the mistake .
**Sherman tse** (2025-09-11):
Verified on QA
Test case attached
Issue involved: FE, MPOS IPA, MPOS API, webview
path:
FE: [\\ds411\share\POS_FE_Release_64\20250904](file://ds411/share/POS_FE_Release_64/20250904) Coach v750.04R14a
MPOS ipa: 3.30.6-20250908.1Coach
...
Weeks since:
**Joy Li** (2025-09-16):
released V3.119a for missing dbconfig (released on 2025-09-16)
