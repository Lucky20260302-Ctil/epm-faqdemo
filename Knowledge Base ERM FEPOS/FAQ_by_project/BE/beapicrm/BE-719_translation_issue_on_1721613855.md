...
symptom: "Env: [https://172.16.138.55/ChainStorePlus_AIGLE/home](https://172.16.138.101/chainstoreplus/home)"
root-cause: "待提取"
...
# BE-719: Translation issue on 172.16.138.55

## 問題

Env: [https://172.16.138.55/ChainStorePlus_AIGLE/home](https://172.16.138.101/chainstoreplus/home)
...
9. Financial Period Maintenance 財政年度資料
Specials (Custom):
...
3. Define Main Category Inclusive List for accounting Interface
4. In Progress Referencr No. Enquiry
5. Category Tax Rate
In house menu
1. In House Program
2. Target Sales Report
On sale Price Interface Node Maintenance
1. On sale Price Interface Node Maintenance
...
10. User Password Restricted Keyword
11. User Password Policy
12. User Table Amendment Log
...
- Jira: [BE-719](https://ctil.atlassian.net/browse/BE-719)
- Fix Version: 未記錄
- 解決日期: 2023-11-16
